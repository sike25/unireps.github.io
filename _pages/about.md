...
---
🚨 <strong> Submission deadline extended to 31st October 2025 (AoE) </strong>
...
<ul>
  <li>New or early-stage research results 🧑‍🔬</li>
  <li>Tutorial-style summaries of key methods and literature 🔍</li>
  <li>Opinion pieces on relevant topics in UniReps 🧠</li>
</ul>
</p>
...
<ul>
  ...
  <strong><s style="color:#888;">25th October 2025 (AoE)</s></strong>
  <strong style="color:#d97706;">31st October 2025 (AoE)</strong>
</ul>
  ...
  <div class="tag-category-list">
    <ul class="p-0 m-0">
      {% for tag in site.display_tags %}
        <li>
          <i class="fa-solid fa-hashtag fa-sm"></i> <a href="{{ tag | slugify | prepend: '/tag/' | relative_url }}">{{ tag }}</a>
        </li>
        {% unless forloop.last %}
          <p>&bull;</p>
        {% endunless %}
      ...
      {% for category in site.display_categories %}
        <li>
          <i class="fa-solid fa-tag fa-sm"></i> <a href="{{ category | slugify | prepend: '/category/' | relative_url }}">{{ category }}</a>
        </li>
        {% unless forloop.last %}
          <p>&bull;</p>
        {% endunless %}
...
<p class="card-text">{{ post.description }}</p>
                    ...
                    <p class="post-meta">
                      ...
                      <a href="{{ year | prepend: site.baseurl}}">
