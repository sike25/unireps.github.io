...
description: Finding Separatrices with Squashed Koopman Eigenfunctions
...
<!-- 
<div class="l-body">
  <iframe src="{{ '/assets/plotly/results2D_plotly_duffing.html' | relative_url }}" frameborder='0' scrolling='no' height="500px" width="100%" style="border: 1px solid grey; max-width: 100%;"></iframe>
</div>
...
<div class="l-body">
  <iframe
    src="{{ '/assets/plotly/lorenz_plot.html' | relative_url }}"
    frameborder="0" scrolling="no" height="500px" width="100%"
    style="border: 1px solid grey; max-width: 100%;">
  </iframe>
</div>
...
<div class="l-body">
  <iframe
    src="{{ '/assets/plotly/lorenz_gaussian.html' | relative_url }}"
    frameborder="0" scrolling="no" height="500px" width="100%"
    style="border: 1px solid grey; max-width: 100%;">
  </iframe>
</div> -->
...
<div class="l-body">
  <iframe
    src="{{ '/assets/plotly/duffing.html' | relative_url }}"
    frameborder="0" scrolling="no" height="500px" width="100%"
    style="border: 1px solid grey; max-width: 100%;">
  </iframe>
</div>
...
<div class="l-body">
  <iframe
    src="{{ '/assets/plotly/duffing_KEF.html' | relative_url }}"
    frameborder="0" scrolling="no" height="500px" width="100%"
    style="border: 1px solid grey; max-width: 100%;">
  </iframe>
</div>
...
<div class="l-body">
  <iframe
    src="{{ '/assets/plotly/results2D_plotly_duffing.html' | relative_url }}"
    frameborder="0" scrolling="no" height="500px" width="100%"
    style="border: 1px solid grey; max-width: 100%;">
  </iframe>
</div>
